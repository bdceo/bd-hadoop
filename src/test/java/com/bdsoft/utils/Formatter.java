...
public static String getJson(String message){
	...
	public static JSONObject getJson(Document root,String jsonXpath,String jsonName,String jsonKey,String jsonNamevalue){
		String jsonValue = "";
		String value = "";
		int index1 = 0;
		int index2 = 0;
		Node jsonNode = null; 
		NodeList nodeList = DomUtil.getNodeList(root,jsonXpath); 
